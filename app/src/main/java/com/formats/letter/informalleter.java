...
public class informalleter extends AppCompatActivity {
    ListView listView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_informalleter);

        String[] main_title ={"• Inviting a friend for a ceremony say for a birthday",
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toasty.success(informalleter.this, value , Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(informalleter.this,informalletter1.class);
