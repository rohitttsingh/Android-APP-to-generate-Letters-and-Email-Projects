...
public class informalletter1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informalletter1);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( s.equals("• Inviting a friend for a ceremony say for a birthday"))
                {
                    ...
                    copy.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Toasty.success(informalletter1.this,"Copied to your Clipboard",Toasty.LENGTH_LONG).show();
                ...
                else if (s.equals("•  Calling a friend for a trip or holiday"))
                {
                    String fromtext  =from.getText().toString();
                ...
                else if(s.equals("•  Asking sorry or apologizing to someone for mistakes you have done"))
                {
                    String fromtext  =from.getText().toString();
                ...
                else if(s.equals("•  Congratulating a friend for his success or achievement"))
                {
                    String fromtext  =from.getText().toString();
                    String datetext= date.getText().toString();
                ...
                else if (s.equals("•  Writing just to ask for the well-being of a person"))
                {
                    String fromtext  =from.getText().toString();
                    String datetext= date.getText().toString();
                ...
                else if (s.equals("•  Invitation for a marriage."))
                {
                    String fromtext  =from.getText().toString();
                ...
                else if (s.equals("•  Asking help from someone"))
                {
                    String fromtext  =from.getText().toString();
                ...
                else if (s.equals("•  Informing about someone’s demise in family or friends"))
                {
                    String fromtext  =from.getText().toString();
                ...
                else if (s.equals("•  Invitation for a  party"))
                {
                    String fromtext  =from.getText().toString();
                    String datetext= date.getText().toString();
